...
import type { ExtensionObject } from './extension-object.js';
import type { DataValue } from './data-value.js';
import type { DiagnosticInfo } from './diagnostic-info.js';
...
export class Variant {
   ...
   */
  public readonly arrayDimensions: number[] | null;
  ...
  constructor(
    ...
    value: VariantValue | VariantArrayValue = null,
   ...
   * 
   * @returns A new Variant with null value
   */
  ...
  public equals(other: Variant): boolean {
    ...
    if (this.arrayDimensions !== null || other.arrayDimensions !== null) {
      if (this.arrayDimensions === null || other.arrayDimensions === null) {
        return false;
      }
