...
// import type { IWriter } from '../../interfaces/encoder.js';
// import type { IDecoder } from '../../interfaces/decoder.js';
// import { ExtensionObject, ExtensionObjectEncoding } from '../../../types/extensionObject.js';
// import { expandedNodeIdEncodeBinary } from './expandedNodeId.js';
// import { nodeIdDecodeBinary, nodeIdEncodeBinary } from './nodeId.js';
// import { ByteString } from '../../../types/bytestring.js';
...
//  */
// export function extensionObjectEncodeBinary(encoder: IWriter, value: ExtensionObject): void {
...
//     expandedNodeIdEncodeBinary(encoder, adapted.typeId);
//   } else {
//     nodeIdEncodeBinary(encoder, adapted.typeId);
//   }
...
//  */
// export function extensionObjectDecodeBinary(decoder: IDecoder): ExtensionObject {
//   // Decode TypeId (always NodeId for ExtensionObject)
//   const typeId = nodeIdDecodeBinary(decoder);
