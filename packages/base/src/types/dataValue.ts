...
export class DataValue {
   ...
   */
  public readonly value: Variant | undefined;
   ...
   */
  public readonly statusCode: StatusCode | undefined;

  /**
   * The timestamp from the data source.
   * Null if no source timestamp is present.
   */
  public readonly sourceTimestamp: Date | undefined;

  /**
   * The timestamp from the server.
   * Null if no server timestamp is present.
   */
  public readonly serverTimestamp: Date | undefined;
   ...
   * Null if not present.
   */
  public readonly sourcePicoseconds: number | undefined;
   ...
   * Null if not present.
   */
  public readonly serverPicoseconds: number | undefined;
  ...
  constructor(
    ...
    sourceTimestamp: Date | undefined = undefined,
  ...
  public hasSourceTimestamp(): boolean {
    return this.sourceTimestamp !== undefined;
  }
  ...
  public hasServerTimestamp(): boolean {
    return this.serverTimestamp !== undefined;
  }
